                ...
                <div v-if="confirmClear" class="confirmation-modal">
                    <div class="container" :style="{ borderColor: popStyle }">
                        ...
                        <div class="btns">
                            ...
                            <NoHoverButton @click="clearFormBtn" text="確認重填" :btnbgColor="clearbtnbg">
                            </NoHoverButton>
                        </div>
                    </div>
                </div>

...
export default {
    ...
    mounted() {
        // console.log(this.animalData.名稱);
    },
}
</script>
<template>
    <div class="cardFrameAll">
        ...
        <div class="timeShare">
            ...
            <div class="shareIcon">
                <span>分享至</span>
                <div class="Icon"><img src="../assets/Image/CardImage/IconFb.svg" alt=""></div>
                <div class="Icon"><img src="../assets/Image/CardImage/IconLine.svg" alt=""></div>
            </div>
        </div>
    </div>
</template>
